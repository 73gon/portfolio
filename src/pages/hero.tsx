...
export function HeroSection() {
  ...
  return (
    <section id='home' className='container flex flex-col gap-10 py-20 sm:py-32 max-w-7xl'>
      <motion.div initial='initial' animate='animate' transition={{ staggerChildren: 0.15 }} className='space-y-6'>
        ...
        <motion.div variants={fadeInUp} transition={{ duration: 0.5 }} className='flex flex-wrap items-center gap-4 pt-2'>
